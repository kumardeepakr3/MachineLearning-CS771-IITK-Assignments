...
if __name__ == "__main__":
	...
	maxDepthList = [3, 4, 5]
	nEstimatorsList = [50, 100, 150, 200, 250, 300, 350, 400]
	for depth in maxDepthList:
		clf = DecisionTreeClassifier(max_depth=depth)
		for estimator in nEstimatorsList:
			clf2 = AdaBoostClassifier(clf, n_estimators=estimator)
			clf2.fit(X, Y)
			score = clf2.score(testX, testY)
			print depth, " ", estimator, " :", score*100
